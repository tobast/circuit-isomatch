...
circuit_handle build_assert(const char* name, expr_handle expr);

/** Add an input wire to a given gate (order matters!)
 * @return 0 on success, > 0 on failure
 */
int build_assert_add_input(wire_handle wire);
...
circuit_handle build_comb();

/** Add an input wire to a given combinator gate
 * @return 0 on success, > 0 on failure
 */
int build_comb_add_input(wire_handle wire);

/** Add an output wire, alongside with an expression, to a given comb gate
 * @return 0 on success, > 0 on failure
 */
int build_comb_add_output(wire_handle wire, expr_handle expr);
...
/// Build a delay gate
circuit_handle build_delay(wire_handle input, wire_handle output);
 ...
 * @return 0 on success, > 0 on failure
 */
int build_group_add_input(circuit_handle group,
        wire_handle actual,
        wire_handle formal);
 ...
 * @return 0 on success, > 0 on failure
 */
int build_group_add_output(circuit_handle group,
        wire_handle actual,
        wire_handle formal);
...
circuit_handle build_tristate(wire_handle from,
        wire_handle to,
        wire_handle enable);
